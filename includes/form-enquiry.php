...
<script>
	...
	//If have problem with  $ is not a function, you can put insed $ put jQuery or create function like this (function ($) { ..... })(jQuery)
    ...
    (function ($) {
        ...
        $('#enquiry').submit(function (event) {
            ...
            var form = $('#enquiry').serialize(); //All data go in one row like string

            var formdata = new FormData;

            formdata.append('action', 'enquiry');
            formdata.append('nonce', '<?php echo wp_create_nonce( 'ajax-nonce' );?>');
            // nonce or CSRF protection, people can not use ajax form without being on our website
